...
import com.example.GymInTheBack.services.mappers.BlogMapper;
...
class BlogResourceIT {
    ...
    public static Blog createEntity(EntityManager em) {
        ...
        if (TestUtil.findAll(em, CategoryBlog.class).isEmpty()) {
            categoryBlog = CategoryBlogResourceIT.createEntity(em);
    ...
    public static Blog createUpdatedEntity(EntityManager em) {
        ...
        CategoryBlog categoryBlog;
        if (TestUtil.findAll(em, CategoryBlog.class).isEmpty()) {
            categoryBlog = CategoryBlogResourceIT.createUpdatedEntity(em);
            em.persist(categoryBlog);
            em.flush();
        } else {
            categoryBlog = TestUtil.findAll(em, CategoryBlog.class).get(0);

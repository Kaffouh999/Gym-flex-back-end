...
import com.binarybrothers.gymflexapi.repositories.ProductRepository;
import com.binarybrothers.gymflexapi.services.mappers.ProductMapper;
...
class ProductControllerTest {
    ...
    private static final Double DEFAULT_QTEIN_S_TOCK = 1D;
    private static final Double UPDATED_QTEIN_S_TOCK = 2D;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .qteinSTock(DEFAULT_QTEIN_S_TOCK)
            .discount(DEFAULT_DISCOUNT);
        // Add required entity
        SubCategory subCategory;
        if (TestUtil.findAll(em, SubCategory.class).isEmpty()) {
            subCategory = SubCategoryControllerTest.createEntity(em);
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product()
            ...
            .qteinSTock(UPDATED_QTEIN_S_TOCK)
            .discount(UPDATED_DISCOUNT);
        // Add required entity
        SubCategory subCategory;
        if (TestUtil.findAll(em, SubCategory.class).isEmpty()) {
            subCategory = SubCategoryControllerTest.createUpdatedEntity(em);
            em.persist(subCategory);
            em.flush();
        } else {
            subCategory = TestUtil.findAll(em, SubCategory.class).get(0);
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getQteinSTock()).isEqualTo(DEFAULT_QTEIN_S_TOCK);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].qteinSTock").value(hasItem(DEFAULT_QTEIN_S_TOCK.doubleValue())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.qteinSTock").value(DEFAULT_QTEIN_S_TOCK.doubleValue()))
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getQteinSTock()).isEqualTo(UPDATED_QTEIN_S_TOCK);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.rating(UPDATED_RATING).qteinSTock(UPDATED_QTEIN_S_TOCK);

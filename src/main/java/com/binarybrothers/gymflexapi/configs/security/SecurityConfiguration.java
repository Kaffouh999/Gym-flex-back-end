package com.binarybrothers.gymflexapi.configs.security;

import com.binarybrothers.gymflexapi.entities.Authority;
import com.binarybrothers.gymflexapi.utils.auth.JwtAuthenticationFilter;
...
public class SecurityConfiguration {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .requestMatchers("/api/auth/**","/api/category-blogs/**")
          .permitAll()
            .requestMatchers("/ws/**")
            .permitAll()
